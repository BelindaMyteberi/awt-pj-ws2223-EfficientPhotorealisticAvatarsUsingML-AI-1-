...
def lbs(betas, pose, offsets, v_template, shapedirs, posedirs, J_regressor, parents,
        lbs_weights, pose2rot=True, dtype=torch.float32, faces=None):
    ''' Performs Linear Blend Skinning with the given shape and pose parameters
        ...
        offsets:
            3D offsets per vertex. Can be None, if not none must be tensor of shape N x V x 3
